...
{
    addAndMakeVisible (mGrantInfoLabel = new Label ("new label",
    ...
    addAndMakeVisible (mCopyrightLabel = new Label ("new label",
    ...
    addAndMakeVisible (mDescriptionLabel = new Label ("Description",
    ...
    addAndMakeVisible (mAudealizeLabel = new Label ("new label",
                                           "Audealize"));
    ...
    addAndMakeVisible (mVersionLabel = new Label ("new label",
...
void AboutComponent::paint (Graphics& g)
{
    ...
    if (mLogoDrawable != 0)
        mLogoDrawable->drawWithin (g, Rectangle<float> (276, 28, 184, 160),
